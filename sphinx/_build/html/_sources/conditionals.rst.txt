...
The first difference is that any variable, unless it is specifically the value 'null' of a boolean or boolean subset, is true.
...
.. warning::
    ...
    boolean.optional does NOT work like any other optional, because the return type of a boolean.optional is inherntly a truthy and falsy value,
    you MUST use .isNull() on the .optional.

.isNull() is also a valid syntax, though not preferred for anything other than a boolean.optional, because any object that would have
.isNull() return true, would evaluate to false inside a conditional.